...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "Telemetry", meta=(WorldContext="WorldContextObject", Keywords="config setup start telemetry"))
    static void ConfigureTelemetry(const UObject* WorldContextObject, const FString& ServerURL);
    
    /** Start new session */
    UFUNCTION(BlueprintCallable, Category = "Telemetry", meta=(WorldContext="WorldContextObject", Keywords="start begin session telemetry"))
    static void StartSession(const UObject* WorldContextObject);
    
    /** End current session */
    UFUNCTION(BlueprintCallable, Category = "Telemetry", meta=(WorldContext="WorldContextObject", Keywords="end stop session telemetry"))
    static void EndSession(const UObject* WorldContextObject);
    
    /** Log position update */
    UFUNCTION(BlueprintCallable, Category = "Telemetry", meta=(WorldContext="WorldContextObject", Keywords="position location telemetry"))
    static void LogPosition(const UObject* WorldContextObject, FVector Position, float GameTime);
    
    /** Log input action */
    UFUNCTION(BlueprintCallable, Category = "Telemetry", meta=(WorldContext="WorldContextObject", Keywords="input action telemetry"))
    ...
    UFUNCTION(BlueprintCallable, Category = "Telemetry", meta=(WorldContext="WorldContextObject", Keywords="input mapping context telemetry"))
    ...
    /** Log damage event */
    UFUNCTION(BlueprintCallable, Category = "Telemetry", meta=(WorldContext="WorldContextObject", Keywords="damage hurt health telemetry"))
    ...
    /** Log death event */
    UFUNCTION(BlueprintCallable, Category = "Telemetry", meta=(WorldContext="WorldContextObject", Keywords="death die killed telemetry"))
